...
const EditJobPage = ({ updateJob }) => {
  ...
  const [description, setDsscription] = useState(job.description);
  ...
  const handleUpdate = (e) => {
    ...
    // hanlde job details update
    const status = updateJob(data);
    console.log(status);
              ...
              <form onSubmit={handleUpdate}>
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    value={description}
                    onChange={(e) => { setDsscription(e.target.value) }}
                  ></textarea>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    name="website"
                    className="border rounded w-full py-2 px-3"
                    placeholder="URL of your company website"
                    value={website}
